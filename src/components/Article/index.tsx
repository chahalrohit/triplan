      ...
      <View backgroundColor={Colors.white} marginT-small style={style}>
        <View paddingH-small paddingV-12 row centerV>
          ...
          <View marginL-8>
            ...
            <View row centerV>
              ...
              <Image source={Assets.icons.ic_heart} />
            </View>
          </View>
        </View>
        <TouchableWithoutFeedback onPress={handleLike}>
          <View>
            ...
            <View absR row>
              ...
              <Image
                source={
                  like ? Assets.icons.ic_wishlisted : Assets.icons.ic_wishlist
                }
                style={{marginTop: 18, marginRight: 17}}
              />
            </View>
        ...
        <View paddingH-small paddingV-14 row>
          <View flex row spread>
            ...
            <TouchableWithoutFeedback>
              <View row centerV>
                <Image
                  source={Assets.icons.ic_article_share}
                  width={13}
                  height={13}
                />
                <Text marginL-10 c59 M14>
          ...
          <View flex centerV right>
            <TouchableWithoutFeedback onPress={handleOpenOption}>
              <Image
                source={Assets.icons.ic_article_menu}
                width={13}
                height={13}
              />
            </TouchableWithoutFeedback>
        ...
        {isShowOption && (
          <View
            ...
            width={width * 0.64}
            style={[styles.menuOption, isLast && {bottom: 50}]}>
            <TouchableHighlight
              activeOpacity={1}
              underlayColor={Colors.cf7}
              style={[
                styles.btnOption,
