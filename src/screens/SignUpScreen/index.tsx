    ...
    <>
      ...
      <KeyboardAwareScrollView
        ...
        <View
          ...
          <View marginB-10>
            <Text c35 B40 marginB-32>
              Sign Up
            </Text>
            <Text
              c59
              M16>{`Sign up with Facebook or Google+ to sync \nyour travel photo.`}</Text>
          </View>
          <View row spread marginB-medium>
            <SocialButton
              socialIcon={Assets.icons.ic_facebook}
              color={Colors.c3b}
              onPress={() => {}}
            />
            <SocialButton
              socialIcon={Assets.icons.ic_gplus}
              color={Colors.cdd4}
              onPress={() => {}}
            />
          </View>
          <Text c59 M14 marginB-medium>
            Or using your email
          </Text>
          <View>
            <InputText
          ...
          <View flex bottom paddingB-42>
            <Text c83 M12 center>
              {`By tapping any of the button above, I agree to triplan’s \n`}
              <Text c83 M12 style={{textDecorationLine: 'underline'}}>
                Term of Service
              </Text>
              <Text c83 M12>
                {' '}
