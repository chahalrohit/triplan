    ...
    <View flex backgroundColor={Colors.white}>
      ...
      <View flex padding-24>
              ...
              return (
                <View row centerV marginB-medium>
                  <View flex-2 row centerV>
                    ...
                    <Text B16 c59 marginL-small>
                      {item.name}
                    </Text>
                  </View>
                  <View flex right>
                    <Checkbox
                      checked={listFriends.indexOf(item.name) !== -1}
                      value={item.name}
        ...
        <View absB width={width} center style={{bottom: 16}}>
          <BaseButton
            primary
            label={`share trip with ${listFriends.length} friends`}
