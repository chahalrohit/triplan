...
import { StyleSheet, ScrollView, TouchableWithoutFeedback, FlatList, Platform } from 'react-native'
...
const DATA: Trip[] = [
    {
        thumbnail: require('../../images/thumbnail_3.png'),
...
const CityGuideScreen: React.FC<Props> = ({
    title
}) => {

    const navigation = useNavigation();

    const onNavigateExchangeMoney = () => navigation.navigate(Routes.ExchangeMoney);
        ...
        return (
            <View flex margin-8 width={width * 0.85} backgroundColor={Colors.white} style={{ borderRadius: 4, ...shadow }}>
                ...
                <View flex paddingH-small paddingB-small paddingT-8>
                    <Text B16 c35 marginB-8 numberOfLines={1} >{item.title}</Text>
                    <View row centerV>
        ...
        <View center flex backgroundColor={Colors.cf2}>
            ...
            <ScrollView style={{ flex: 1, width: width }} showsVerticalScrollIndicator={false}>
                ...
                <View padding-medium flex>
                    <Text B14 c59 uppercase>Place Collections</Text>
                ...
                <View padding-medium flex marginB-medium>
                    <Text B14 c59 uppercase>USEFUL INFOMATION</Text>
                    <View spread marginT-small style={styles.Grid}>
                        <GuideBtn label='Transport' icon={ICTransport} onPress={onNavigateTransportScreen} />
                        <GuideBtn label='Exchange' icon={ICExchange} onPress={onNavigateExchangeMoney} />
                        <GuideBtn label='Weather' icon={ICWeather} onPress={onNavigateWeatherScreen} />
                    </View>
                </View>
                <View paddingT-32 paddingB-small marginB-small paddingL-8 backgroundColor={Colors.white}>
                    <Text B16 c35 uppercase marginL-small marginB-8>Top Trips</Text>
                    <FlatList
                        data={DATA}
                    ...
                    <View row flex right marginT-32 paddingR-18>
                        <Text marginR-10 B13 c04>SHOW ALL</Text>
