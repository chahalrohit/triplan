...
const DATA: Country[] = [
  {
    city: 'London',
    country: 'UK',
    thumbnail: require('../../assets/images/img_london.png'),
  },
  {
    city: 'Paris',
    country: 'France',
    thumbnail: require('../../assets/images/img_paris.png'),
  },
  {
    city: 'New York',
    country: 'USA',
    thumbnail: require('../../assets/images/img_new_york.png'),
  },
  {
    city: 'Boston',
    country: 'USA',
    thumbnail: require('../../assets/images/img_boston.png'),
  },
  {
    city: 'Seoul',
    country: 'Korea',
...
const TravelGuideScreen = () => {
  ...
  const navigateDetail = (item: Country) =>
    navigate.navigate(Routes.GuideDetailTab, {
      ...
      <ScrollView style={{flex: 1}}>
        {listDownload.length > 0 && (
          <>
            ...
            <View style={styles.Grid}>{listDownload.map(renderItem)}</View>
          </>
        )}
        <ListHeader title="Available city" />
        <View style={styles.Grid}>{list.map(renderItem)}</View>
      </ScrollView>
      {isShow && (
        <GuideModal
          {...selected}
