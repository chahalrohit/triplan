...
const DATA_TRIP_DETAIL_DAY_1 = [
    {
        type: 'description',
        content: 'I assume that the dubious pleasure of living right at the airport the biggest drawbacks is closed on holiday flight ungodly hours a day.'
    },
    {
        type: 'location',
        content: {
    ...
    },
    {
        ...
        content: {
            image: 'thumbnail_20',
            title: 'Empire State Building and skyscrapers with lights at night in New York City'
        },
        props: {
            needPadding: true,
            onPressImage: true,
