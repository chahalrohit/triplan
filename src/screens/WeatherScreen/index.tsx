        ...
        <View flex backgroundColor={Colors.white}>
            ...
            <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ flex: 1 }}>
                <View flex centerV paddingH-medium>
                    <Text B14 c35>Boston, MA</Text>
                    <Text M14 c59>as of 10:29 am EDT, Apr 27, 2018</Text>
                </View>
                ...
                <View flex-3 centerV row paddingH-medium>
                    <View flex left>
                        ...
                        <Text M30 c35 center>Rain</Text>
                    </View>
                    <View flex>
                        <Text B14 c83 marginV-4>feels like 51°</Text>
                        <Text B14 c83 marginV-4>H 57° / L 50°</Text>
                        <Text B14 c83 marginV-4>UV Index 1 of 10</Text>
                    </View>
                </View>
                <View row flex-3>
