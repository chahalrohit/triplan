...
export const DATA: Trip[] = [
  {
    thumbnail: require('../../assets/images/thumbnail_16.png'),
...
export const DATA_2: Trip[] = [
  {
    thumbnail: require('../../assets/images/thumbnail_17.png'),
    title: 'Havana Central Times Square',
    location: '151 W 46th St, New York, NY 10036',
  },
  {
    thumbnail: require('../../assets/images/img_cover.png'),
...
export const DATA_3: Hotel[] = [
  ...
  {
    thumbnail: require('../../assets/images/thumbnail_18.png'),
...
export const DATA_5: FollowItemProps[] = [
  {
    avatar: require('../../assets/images/img_avatar_10.png'),
    user: 'Viola Thornton',
    followers: 779,
    trips: 37,
  },
...
export const DATA_6: ArticleProps[] = [
  ...
  },
  {
    name: 'Harold Kelley',
    avatar: require('../../assets/images/img_avatar.png'),
    thumbnail: require('../../assets/images/thumbnail_15.png'),
